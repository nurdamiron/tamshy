          ...
          >
            <Link href={`/projects?region=${region}`}>
              <Card
                hover
                padding="md"
                className={`cursor-pointer transition-all ${selected === region ? 'ring-2 ring-[#1D9E75]' : ''}`}
              ...
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="text-[15px] font-semibold text-[#111B17]">
                        {regionLabels[region]}
                      </h3>
                      <p className="text-[12px] text-[#5A7A6E]">Смотреть проекты</p>
                    </div>
                  </div>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#5A7A6E" strokeWidth="2">
